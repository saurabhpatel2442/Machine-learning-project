...
# -*- coding: utf-8 -*-
"""
Advanced Spam Detection using Hybrid ML Models.

This script implements a spam detection classifier using TF-IDF vectorization
and a combination of Naive Bayes, SVM, and Decision Tree models.
...
# This assumes 'spam_ham_dataset.csv' is in the same directory as the script.
...
# Drop the 'label_num' column and rename the 'Unnamed: 0' column to 'id'
...
plt.xlabel('Label')
plt.ylabel('Count')
# The labels are already 'ham' and 'spam', so direct usage is fine.
plt.show()
...
def preprocess_text(text):
    ...
    - Removes non-alphabetic characters and URLs
    - Converts to lowercase
    - Tokenizes, lemmatizes, and removes stop words
    """
    # Remove all non-alphabetic characters and URLs
...
svm_model = SVC(kernel='linear', probability=True, random_state=42) # probability=True for VotingClassifier
dt_model = DecisionTreeClassifier(random_state=42)

# --- Create a Hybrid (Voting) Classifier ---
...
# Soft voting is often better if the classifiers are well-calibrated.
